...
public class InsertActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dept = findViewById(R.id.inputDept);
    ...
    public void insertData(){
        ...
        StringRequest strRequest = new StringRequest(Request.Method.POST, Constants.INSERT_URL,
                response -> {
                    try {
                        ...
                        for (int i = 0; i < jArray.length(); i++) {
                            ...
                            Toast.makeText(InsertActivity.this, json_data.toString(), Toast.LENGTH_SHORT).show();
                        }
